#%% Simple demo input data using RelationalDfs
...
display_relational_dfs = {users.table_id: users, appliances.table_id: appliances, usage_windows.table_id: usage_windows}


#%% Complete input data dict
# Dummy dict of households with electrical appliances
# Will be read from surveys in OptiMG
nested_input_data_dict = {
    'low_income_hh': {
        'num_users': 20,
        ...
        'drinking_water_demand':
            {
                'standard_drinking_water_demand':
                    {
        ...
        'drinking_water_demand':
            {
                ...
                'food_processing_drinking_water_demand':
                    {
                        'daily_demand': 300,  # daily drinking water demand [l]
                        'water_window_1': [10, 17]
                    }
            },
        'service_water_demands': {
            'irrigation': {
